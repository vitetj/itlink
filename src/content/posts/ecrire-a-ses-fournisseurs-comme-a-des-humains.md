---
title: "Écrire à ses fournisseurs comme à des humains"
description: "Un incident ouvert avec une blague obtient souvent plus vite une réponse qu'un incident ouvert avec une menace. Ce que le ton d'un mail change vraiment sur le traitement d'un dossier, et où s'arrête l'exercice."
published: 2026-07-08
category: humeur
tags: [fournisseurs, communication, support, escalade, redaction]
featured: false
---

Fin juin, un smartphone neuf, sorti de sa boîte le matin même, refuse son enrôlement dans notre gestion de flotte mobile. Jamais utilisé, jamais allumé avant ce jour-là, et pourtant la plateforme le déclare déjà connu et bloqué, avec un code d'erreur que même le moteur de recherche du support ne reconnaît pas.
...
## Trois formulations, et ce qu'elles changent
...
L'humour fonctionne avec **la personne qui vous aide**. Il ne fonctionne pas dans un document contractuel, dans une demande d'audit, ni quand vous avez besoin d'un « non » écrit et argumenté pour appuyer une décision d'investissement. Ce mois-ci, j'ai posé à un constructeur [une question technique sur la requalification de matériel](/docs/virtualisation/recycler-du-materiel-hyperconverge-les-questions-a-poser/) : quatre questions fermées, une analyse technique jointe, zéro fioriture. La réponse a été un non parfaitement documenté, et ce non valait décision. Une blague dans ce mail-là aurait affaibli le document que j'allais présenter en interne.

La règle que j'applique désormais tient en une phrase : **le registre léger pour les personnes, le registre strict pour les documents**. Un incident, une relance, un remerciement : humain. Une exigence, un engagement, une réserve, [une demande de plan de remédiation](/docs/dsi/auditer-un-fournisseur-saas-et-exiger-un-plan-de-remediation/) : écrit comme si un juriste allait le relire, parce que c'est parfois le cas.
...
<!-- source : mail d'ouverture d'incident MDM, 2026-06-24 ; échanges fournisseurs et question technique constructeur, 2026-06-16 et 2026-06-25 -->
